...
TEST(NetTest, net_execute_base_test_worker) {
    ...
    for (auto iter = models.begin(); iter < models.end(); iter++) {
        ...
        auto h_tensor_in_0 = new Tensor<Target_H,AK_FLOAT>();
        auto h_tensor_in_1 = new Tensor<Target_H,AK_FLOAT>();
        auto h_tensor_in_2 = new Tensor<Target_H,AK_FLOAT>();
